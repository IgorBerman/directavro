...
public abstract class DirectFileOutputFormat<K, V> extends OutputFormat<K, V> {
  ...
  private DirectFileOutputCommitter committer = null;
...
public static final String OUTDIR = "mapreduce.output.fileoutputformat.outputdir";
  ...
  public static Path getWorkOutputPath(TaskInputOutputContext<?,?,?,?> context
    ...
    DirectFileOutputCommitter committer = (DirectFileOutputCommitter) 
  ...
  public Path getDefaultWorkFile(TaskAttemptContext context,
    ...
    DirectFileOutputCommitter committer = 
      (DirectFileOutputCommitter) getOutputCommitter(context);
